...
public class NewsActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {
    ...
    public static final String JSON_LINK = "http://content.guardianapis.com/search?q=debates&api-key=test&show-tags=contributor";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, newsUrl);
    ...
    public void onLoadFinished(Loader<List<News>> loader, List<News> news) {
        ...
        mEmptyStateTextView.setText(getString(R.string.no_info));
